...
| T09 | Recent Trades 改为 API 调用 | `apps/web/app/markets/[slug]/page.tsx` | ⬜ | `MOCK_TRADES` 引用移除，调 API |
| T10 | 创建市场加 10 USDD 创建费 | `apps/web/app/create/page.tsx` | ⬜ | 部署时 TronLink 弹两次签名（创建费+流动性） |
